...
[
    ...
    "JCA_V_CarrierRigKBT_01_command_MTP_alpine_F",
    "JCA_V_CarrierRigKBT_01_command_MTP_arid_F",
    "JCA_V_CarrierRigKBT_01_command_MTP_desert_F",
    "JCA_V_CarrierRigKBT_01_command_MTP_tropic_F",
    "JCA_V_CarrierRigKBT_01_command_MTP_woodland_F",
    "JCA_V_CarrierRigKBT_01_command_black_F",
    "JCA_V_CarrierRigKBT_01_command_olive_F",
    "JCA_V_CarrierRigKBT_01_command_sand_F",
    "JCA_V_CarrierRigKBT_01_CQB_MTP_alpine_F",
    "JCA_V_CarrierRigKBT_01_CQB_MTP_arid_F",
    "JCA_V_CarrierRigKBT_01_CQB_MTP_desert_F",
    "JCA_V_CarrierRigKBT_01_CQB_MTP_tropic_F",
    "JCA_V_CarrierRigKBT_01_CQB_MTP_woodland_F",
    ...
    "JCA_V_CarrierRigKBT_01_tactical_MTP_alpine_F",
    "JCA_V_CarrierRigKBT_01_tactical_MTP_arid_F",
    "JCA_V_CarrierRigKBT_01_tactical_MTP_desert_F",
    "JCA_V_CarrierRigKBT_01_tactical_MTP_tropic_F",
    "JCA_V_CarrierRigKBT_01_tactical_MTP_woodland_F",
...
switch (true) do
{
    ...
    {
		if (count units _grp > 3 && {leader _grp isNotEqualTo player}) then {_itemLeaderEquipment = []; _itemSpecial = []; };
